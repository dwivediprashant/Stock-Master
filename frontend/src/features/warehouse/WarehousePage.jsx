...
const WarehousePage = () => {
  ...
  const handleEdit = (warehouse) => {
    ...
    setForm({ name: warehouse.name, shortCode: warehouse.shortCode, address: warehouse.address });
    setShowForm(true);
  };
      ...
      {showForm && (
        <div className="card shadow-sm mb-4">
          <div className="card-body">
            <h5 className="card-title mb-3">{editing ? "Edit" : "Create"} Warehouse</h5>
            <form onSubmit={handleSubmit}>
              ...
              <div className="mb-3">
                ...
                <input type="text" className="form-control" name="shortCode" value={form.shortCode} onChange={handleChange} required />
              </div>
              <div className="mb-3">
                ...
                {warehouses.map((w) => (
                  <tr key={w._id}>
                    ...
                    <td className="text-end pe-4">
                      <button className="btn btn-sm btn-outline-primary me-2" onClick={() => handleEdit(w)}>
